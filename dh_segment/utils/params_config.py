...
class TrainingParams(BaseParams):
    ...
    def __init__(self, **kwargs):
        ...
        self.input_resized_size = int(kwargs.get('input_resized_size', -1))  # (1200*2400) (600*1200) (-1 for no resizing)
        # BLK weights
        # self.weights_labels = kwargs.get('weights_labels', [0.79866428, 2.50959536, 0.74104878])
        # BLKX weights
        #self.weights_labels = kwargs.get('weights_labels', [0.598998, 1.882196, 0.559629, 80.945462])
        # SEP weights
        #self.weights_labels = kwargs.get('weights_labels', [0.25206538, 104.46558879, 79.04658257, 94.76886243])

        # eparchos_basic weights
        #self.weights_labels = kwargs.get('weights_labels', [41.868, 56.067, 0.347, 0.927])
        # eparchos_advanced weights
        #self.weights_labels = kwargs.get('weights_labels', [33.494, 46.511, 0.294, 6.453,  0.715])

        self.weights_labels = kwargs.get('weights_labels', None)
        self.weights_evaluation_miou = kwargs.get('weights_evaluation_miou', None)
        self.training_margin = kwargs.get('training_margin', 0)
